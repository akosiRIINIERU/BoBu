...
export default function Payments() {
  ...
  const handleSendNotice = (tenant) => {
    // Set selected tenant to show chat box
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 26, fontWeight: "bold", color: "#1D1D82", marginBottom: 20, textAlign: "center" },
  itemContainer: { 
    backgroundColor: "#fff", 
    padding: 15, 
    borderRadius: 12, 
  ...
  info: { flex: 2 },
  name: { fontSize: 18, fontWeight: "bold", color: "#1D1D82" },
  details: { fontSize: 14, color: "#555", marginTop: 3 },
  payment: { flex: 1, alignItems: "flex-end" },
  amount: { fontSize: 16, fontWeight: "bold", color: "#1D1D82" },
  status: { marginTop: 5, paddingVertical: 2, paddingHorizontal: 8, borderRadius: 12, fontSize: 12, fontWeight: "bold", overflow: "hidden" },
  ...
  noticeText: { fontSize: 12, fontWeight: "bold", color: "#fff" },
  ...
  chatTitle: { fontSize: 20, fontWeight: "bold", color: "#1D1D82", marginBottom: 15 },
